...
public class TP1 {
    ...
    public static void mostrarAlunos(){
        if(nomeAlunos[0]==null){
            System.out.println("nao tem dados para apresentar");
        }
        else{
    ...
    public static void mostrarAlunos(int tela) {
        if (nomeAlunos[0]==null){
            ...
            if(tela-1 > nomeAlunos.length-1){
                for (int i=0; i <= nomeAlunos.length-1; i++) {
                    if (nomeAlunos[i] != null) {
                        System.out.println("aluno: "+nomeAlunos[i]+" nota- "+notasAlunos[i]);
                    }
                }
            }else{
                for (int i=0; i <= tela-1; i++){
                    if (nomeAlunos[i] != null){
                        System.out.println("aluno: "+nomeAlunos[i]+" nota- "+notasAlunos[i]);
                    }
                }
    ...
    public static void mostraResumo(){
        ...
        System.out.println("alunos com nota inferior a media: "+ nrnotamin," alunos com nota superior a media: "+ notamax);
    }
